...
//         `/api/product-pdfs?shop=${encodeURIComponent(shop)}&page=${page}&limit=${limit}`,
//         {
//           method: "GET",
//           headers: {
...
export default function ProductPDFListPage() {
  ...
  return (
    <Page
      ...
      // subtitle={
      //   flatPDFs.length > 0 
      //     ? `Showing ${flatPDFs.length} PDFs (Page ${page} of ${paginationMeta.totalPages})`
      //     : ""
      // }
      primaryAction={{
        content: "Add PDF",
